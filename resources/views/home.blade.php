...
<body>
    ...
    <div class="container">
        ...
        <div class="menu-grid">
            ...
            <!-- Card Comprimir PDF -->
            <a href="{{ route('comprimir') }}" class="menu-card">
                <div class="menu-card-icon" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p>Reduce el tamaño de PDFs que ya tienen 300 DPI sin perder calidad</p>
                <div class="menu-card-features">
                    <span>✓ Mantiene 300 DPI</span>
                    <span>✓ Múltiples niveles</span>
                    <span>✓ Compresión inteligente</span>
                    <span>✓ Sin rasterizar</span>
                </div>
                <div class="menu-card-action">
                    Comprimir PDF →
                </div>
            ...
            <!-- Card Combinar PDFs -->
            <a href="{{ route('combinar') }}" class="menu-card">
                <div class="menu-card-icon" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M14 2V8H20" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <h2>📑 Combinar PDFs</h2>
                <p>Une múltiples PDFs en uno solo manteniendo 300 DPI</p>
                <div class="menu-card-features">
                    <span>✓ Mantiene 300 DPI</span>
